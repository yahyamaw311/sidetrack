...
import { skelStyles, styles } from '../../screens/MovieDetail.styles';

interface MovieDetailSkeletonProps {
  onBack?: () => void;
}

export const MovieDetailSkeleton: React.FC<MovieDetailSkeletonProps> = ({ onBack }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={skelStyles.wrapper}>
        <Animated.View style={[skelStyles.backdrop, { opacity: shimmerOpacity, height: height * 0.4 }]} />
